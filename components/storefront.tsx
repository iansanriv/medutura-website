...
export default function Storefront() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#fbffff] text-[#111827]">
      ...
      <footer className="bg-[#80e3e0]"><div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-4 py-10 text-center sm:flex-row sm:px-6 sm:text-left lg:px-8"><div className="flex items-center gap-3"><span className="grid h-16 w-16 shrink-0 place-items-center rounded-2xl bg-white shadow-sm ring-1 ring-black/8"><img src="/medutura-symbol-v3.png" alt="" className="h-14 w-14 object-contain" /></span><div><div className="brand-word text-xl font-black">MEDUTURA</div><p className="text-sm text-[#0c5c60]">Cosido con cariño en Puerto Rico.</p></div></div><a href="https://www.instagram.com/medutura/" target="_blank" rel="noreferrer" className="flex items-center gap-2 rounded-full bg-[#111827] px-5 py-3 text-sm font-bold text-white"><Instagram className="h-4 w-4" /> @medutura</a></div></footer>
