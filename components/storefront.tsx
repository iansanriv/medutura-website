...
export default function Storefront() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#fbffff] text-[#111827]">
      ...
      <footer className="bg-[#0c5c60] text-white"><div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-4 py-10 text-center sm:flex-row sm:px-6 sm:text-left lg:px-8"><div className="flex items-center gap-3"><img src="/medutura-symbol-v3.png" alt="" className="h-16 w-16 shrink-0 object-contain" /><div><div className="brand-word text-xl font-black">MEDUTURA</div><p className="text-sm text-white/70">Cosido con cariño en Puerto Rico.</p></div></div><a href="https://www.instagram.com/medutura/" target="_blank" rel="noreferrer" className="flex items-center gap-2 rounded-full bg-[#80e3e0] px-5 py-3 text-sm font-bold text-[#111827]"><Instagram className="h-4 w-4" /> @medutura</a></div></footer>
