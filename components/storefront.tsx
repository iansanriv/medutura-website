...
export default function Storefront() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#fbffff] text-[#111827]">
      ...
      <div className="bg-[#111827] px-4 py-2 text-center text-sm font-medium text-white">Diseñado y confeccionado en el Área Metro</div>
